...
/**
 * Connects semantic YouTube Music anchors to the stable Jam extension API.  Native discovery is
 * kept in [JamAbi] and [JamUiAbi]; generated methods are small access or interception bridges.
 */
@Suppress("unused")
val jamQueueProbePatch = bytecodePatch(
    ...
    execute {
        ...
        val queue = baseQueue.copy(
            item = baseQueue.item.copy(menuPayload = ui.queueRow.menuPayload),
        )
